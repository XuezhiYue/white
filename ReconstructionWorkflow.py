...
"""
  ...
  @Software: PyCharm
  @FileName: ReconstructionWorkflow.py
...
for line in execute(
        [photoscanName, "-r", codeDir, image_folder, coordReference, outputPointCloud, key_str, tie_str, filter_1_str,
         filter_2_str, filter_3_str, size_str, alignAccuracy, pcAccuracy]):
    print(line, end="")
